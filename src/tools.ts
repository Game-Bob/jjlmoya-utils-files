...
export const ALL_TOOLS: ToolDefinition[] = [CLIPBOARD_TO_IMAGE_TOOL, FORMAT_STRIPPER_TOOL, CHARACTER_COUNTER_TOOL, HASH_VERIFIER_TOOL, TEXT_TO_MARKDOWN_TOOL, EMOJI_SPACE_CLEANER_TOOL, TEXT_SPLITTER_TOOL, JSON_TO_CSV_TOOL, FILE_SIZE_CONVERTER_TOOL];
