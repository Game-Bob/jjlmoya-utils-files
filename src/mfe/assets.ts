...
const UTILITY_ASSET_ROOT = "/_utilities/files";
...
export const getUtilityOgImage = (englishSlug: string): string =>
    withAssetVersion(`/_utilities/files/images/${englishSlug}.webp`);

export const getUtilityCssPath = (englishSlug: string): string =>
    withAssetVersion(`/_utilities/files/styles/${englishSlug}.css`);

export const CATEGORY_OG_IMAGE = getUtilityOgImage("files");
