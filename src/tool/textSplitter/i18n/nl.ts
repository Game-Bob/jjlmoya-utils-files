...
export const content: ToolLocaleContent<TextSplitterUI> = {
  ...
  bibliography: [
    { name: 'Unicode algoritme voor regelafbreking', url: 'https://unicode.org/reports/tr14/' },
    { name: 'NLP: Technieken voor het splitsen van zinnen', url: 'https://nl.wikipedia.org/wiki/Zinssegmentatie' },
    { name: 'LLM context window limieten', url: 'https://help.openai.com/en/articles/4936856-what-are-tokens-and-how-to-count-them' },
  ],
  howTo: howToData,
  ...
  ui: {
    ...
    labelOutput: 'Gesplitste Delen',
    labelMethod: 'Splitsmethode',
    labelValue: 'Max per deel',
    placeholderInput: 'Plak lange tekst hier...',
    placeholderOutput: 'De gesplitste delen verschijnen hier...',
    optionChars: 'Tekens',
    optionWords: 'Woorden',
    optionSentences: 'Zinnen',
    optionParagraphs: 'Alinea\'s',
    btnSplit: 'Splits Tekst',
    btnCopy: 'Kopieer Deel',
    btnClear: 'Alles wissen',
    toastCopied: 'Deel gekopieerd naar klembord!',
    labelPartsFound: 'Gegenereerde delen',
  },
};
