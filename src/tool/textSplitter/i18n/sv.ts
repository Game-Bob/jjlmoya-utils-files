...
export const content: ToolLocaleContent<TextSplitterUI> = {
  ...
  ui: {
    ...
    labelOutput: 'Uppdelade delar',
    labelMethod: 'Delningsmetod',
    labelValue: 'Max per del',
    placeholderInput: 'Klistra in lång text här...',
    placeholderOutput: 'De uppdelade delarna visas här...',
    optionChars: 'Tecken',
    optionWords: 'Ord',
    optionSentences: 'Meningar',
    optionParagraphs: 'Stycken',
    btnSplit: 'Dela upp text',
    btnCopy: 'Kopiera del',
    btnClear: 'Rensa allt',
    toastCopied: 'Del kopierad till urklipp!',
    labelPartsFound: 'Genererade delar',
  },
};
