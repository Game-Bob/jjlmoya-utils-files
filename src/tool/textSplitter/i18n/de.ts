...
export const content: ToolLocaleContent<TextSplitterUI> = {
  ...
  ui: {
    ...
    labelOutput: 'Geteilte Teile',
    labelMethod: 'Teilungsmethode',
    labelValue: 'Max. pro Teil',
    placeholderInput: 'Langen Text hier einfügen...',
    placeholderOutput: 'Die geteilten Teile werden hier erscheinen...',
    optionChars: 'Zeichen',
    optionWords: 'Wörter',
    optionSentences: 'Sätze',
    optionParagraphs: 'Absätze',
    btnSplit: 'Text teilen',
    btnCopy: 'Teil kopieren',
    btnClear: 'Alles leeren',
    toastCopied: 'Teil in die Zwischenablage kopiert!',
    labelPartsFound: 'Generierte Teile',
  },
};
