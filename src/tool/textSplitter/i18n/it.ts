...
export const content: ToolLocaleContent<TextSplitterUI> = {
  ...
  bibliography: [
    { name: 'Algoritmo di interruzione di riga Unicode', url: 'https://unicode.org/reports/tr14/' },
    { name: 'NLP: Tecniche di divisione delle frasi', url: 'https://it.wikipedia.org/wiki/Segmentazione_delle_frasi' },
    { name: 'Limiti della finestra di contesto LLM', url: 'https://help.openai.com/en/articles/4936856-what-are-tokens-and-how-to-count-them' },
  ],
  howTo: howToData,
  ...
  ui: {
    ...
    labelOutput: 'Parti Divise',
    labelMethod: 'Metodo di Divisione',
    labelValue: 'Max per parte',
    placeholderInput: 'Incolla qui il testo lungo...',
    placeholderOutput: 'Le parti divise appariranno qui...',
    optionChars: 'Caratteri',
    optionWords: 'Parole',
    optionSentences: 'Frasi',
    optionParagraphs: 'Paragrafi',
    btnSplit: 'Dividi Testo',
    btnCopy: 'Copia Parte',
    btnClear: 'Cancella Tutto',
    toastCopied: 'Parte copiata negli appunti!',
    labelPartsFound: 'Parti generate',
  },
};
