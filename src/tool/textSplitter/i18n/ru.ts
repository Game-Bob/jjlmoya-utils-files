...
export const content: ToolLocaleContent<TextSplitterUI> = {
  ...
  bibliography: [
    { name: 'Алгоритм переноса строк Unicode', url: 'https://unicode.org/reports/tr14/' },
    { name: 'NLP: Техники сегментации предложений', url: 'https://ru.wikipedia.org/wiki/Сегментация_предложений' },
    { name: 'Лимиты контекстного окна LLM', url: 'https://help.openai.com/en/articles/4936856-what-are-tokens-and-how-to-count-them' },
  ],
  howTo: howToData,
  ...
  ui: {
    ...
    labelOutput: 'Разделенные части',
    labelMethod: 'Метод разделения',
    labelValue: 'Макс. на часть',
    placeholderInput: 'Вставьте длинный текст здесь...',
    placeholderOutput: 'Разделенные части появятся здесь...',
    optionChars: 'Символы',
    optionWords: 'Слова',
    optionSentences: 'Предложения',
    optionParagraphs: 'Абзацы',
    btnSplit: 'Разделить текст',
    btnCopy: 'Копировать часть',
    btnClear: 'Очистить всё',
    toastCopied: 'Часть скопирована в буфер обмена!',
    labelPartsFound: 'Созданные части',
  },
};
