...
export const content: ToolLocaleContent<TextSplitterUI> = {
  ...
  ui: {
    ...
    labelOutput: 'Bölünmüş Parçalar',
    labelMethod: 'Bölme Yöntemi',
    labelValue: 'Parça başına maks.',
    placeholderInput: 'Uzun metni buraya yapıştırın...',
    placeholderOutput: 'Bölünmüş parçalar burada görünecektir...',
    optionChars: 'Karakter',
    optionWords: 'Kelime',
    optionSentences: 'Cümle',
    optionParagraphs: 'Paragraf',
    btnSplit: 'Metni Böl',
    btnCopy: 'Parçayı Kopyala',
    btnClear: 'Hepsini Temizle',
    toastCopied: 'Parça panoya kopyalandı!',
    labelPartsFound: 'Oluşturulan parçalar',
  },
};
