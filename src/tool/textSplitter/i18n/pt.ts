...
export const content: ToolLocaleContent<TextSplitterUI> = {
  ...
  ui: {
    ...
    labelOutput: 'Resultado (um item por linha)',
    placeholderInput: 'Cole aqui a sua lista separada por vírgulas, espaços ou qualquer delimitador...',
    placeholderOutput: 'A lista aparecerá aqui...',
    labelDelimiter: 'Delimitador',
    optComma: 'Vírgula (,)',
    optSemicolon: 'Ponto e vírgula (;)',
    optSpace: 'Espaço',
    optCustom: 'Personalizado',
    labelCustom: 'Delimitador personalizado',
    placeholderCustom: 'Introduza o delimitador...',
    optTrim: 'Cortar espaços',
    optUnique: 'Remover duplicados',
    optClean: 'Remover vazios',
    optNumbered: 'Numerar linhas',
    statLines: 'Linhas resultantes',
