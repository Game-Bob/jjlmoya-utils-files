...
export const content: ToolLocaleContent<TextSplitterUI> = {
  ...
  ui: {
    ...
    labelOutput: 'Wynik (jeden element na wiersz)',
    placeholderInput: 'Wklej tutaj listę oddzieloną przecinkami, spacjami lub innym separatorem...',
    placeholderOutput: 'Lista pojawi się tutaj...',
    labelDelimiter: 'Separator',
    optComma: 'Przecinek (,)',
    optSemicolon: 'Średnik (;)',
    optSpace: 'Spacja',
    optCustom: 'Niestandardowy',
    labelCustom: 'Niestandardowy separator',
    placeholderCustom: 'Wprowadź separator...',
    optTrim: 'Przytnij spacje',
    optUnique: 'Usuń duplikaty',
    optClean: 'Usuń puste',
    optNumbered: 'Numeruj wiersze',
    statLines: 'Wiersze wynikowe',
    statChars: 'Znaki',
