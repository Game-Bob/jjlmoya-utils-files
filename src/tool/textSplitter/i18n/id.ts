...
export const content: ToolLocaleContent<TextSplitterUI> = {
  ...
  ui: {
    labelInput: 'Teks untuk Dipisah',
    labelOutput: 'Hasil (satu item per baris)',
    placeholderInput: 'Tempel daftar yang dipisahkan koma, spasi, atau pemisah lainnya di sini...',
    placeholderOutput: 'Daftar akan muncul di sini...',
    labelDelimiter: 'Pemisah',
    optComma: 'Koma (,)',
    optSemicolon: 'Titik koma (;)',
    optSpace: 'Spasi',
    optCustom: 'Kustom',
    labelCustom: 'Pemisah kustom',
    placeholderCustom: 'Masukkan pemisah...',
    optTrim: 'Hapus spasi',
    optUnique: 'Hapus duplikat',
    optClean: 'Hapus yang kosong',
    optNumbered: 'Nomori baris',
    statLines: 'Baris hasil',
    statChars: 'Karakter',
    btnCopy: 'Salin Daftar',
    btnClear: 'Bersihkan',
