...
export const content: ToolLocaleContent<TextSplitterUI> = {
  ...
  bibliography: [
    { name: 'Algorithme de saut de ligne Unicode', url: 'https://unicode.org/reports/tr14/' },
    { name: 'NLP : Techniques de division de phrases', url: 'https://fr.wikipedia.org/wiki/D%C3%A9coupage_en_phrases' },
    { name: 'Limites de la fenêtre de contexte LLM', url: 'https://help.openai.com/en/articles/4936856-what-are-tokens-and-how-to-count-them' },
  ],
  howTo: howToData,
  ...
  ui: {
    ...
    labelOutput: 'Parties Divisées',
    labelMethod: 'Méthode de Division',
    labelValue: 'Max par partie',
    placeholderInput: 'Collez le texte long ici...',
    placeholderOutput: 'Les parties divisées apparaîtront ici...',
    optionChars: 'Caractères',
    optionWords: 'Mots',
    optionSentences: 'Phrases',
    optionParagraphs: 'Paragraphes',
    btnSplit: 'Diviser le Texte',
    btnCopy: 'Copier la Partie',
    btnClear: 'Tout effacer',
    toastCopied: 'Partie copiée dans le presse-papiers !',
    labelPartsFound: 'Parties générées',
  },
};
