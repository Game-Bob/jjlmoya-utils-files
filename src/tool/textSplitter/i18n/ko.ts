...
export const content: ToolLocaleContent<TextSplitterUI> = {
  ...
  ui: {
    ...
    labelMethod: '분할 방법',
    labelValue: '부분당 최대값',
    placeholderInput: '여기에 긴 텍스트를 붙여넣으세요...',
    placeholderOutput: '나누어진 부분이 여기에 나타납니다...',
    optionChars: '글자 수',
    optionWords: '단어 수',
    optionSentences: '문장 기준',
    optionParagraphs: '단락 기준',
    btnSplit: '텍스트 나누기',
    btnCopy: '부분 복사',
    btnClear: '모두 지우기',
    toastCopied: '부분이 클립보드로 복사되었습니다!',
    labelPartsFound: '생성된 부분 수',
  },
};
