...
export const content: ToolLocaleContent<HashVerifierUI> = {
  ...
  ui: {
    labelFile: 'Выберите или перетащите файл',
    labelAlgorithm: 'Выберите алгоритм',
    labelExpectedHash: 'Ожидаемый хэш (опционально)',
    labelStatus: 'Статус сравнения',
    placeholderHash: 'Вставьте сюда хэш, предоставленный автором...',
    btnCompare: 'Проверить целостность',
    btnClear: 'Очистить всё',
    toastCopied: 'Рассчитанный хэш скопирован!',
    statusMatch: 'Хэши совпадают! Файл подлинный.',
    statusMismatch: 'Хэши НЕ совпадают. Файл может быть поврежден или изменен.',
    statusWaiting: 'Ожидание хэша для сравнения...',
  },
};
