...
export const content: ToolLocaleContent<HashVerifierUI> = {
  ...
  ui: {
    labelFile: 'Selecione ou arraste o arquivo',
    labelAlgorithm: 'Selecione o Algoritmo',
    labelExpectedHash: 'Hash Esperado (opcional)',
    labelStatus: 'Estado da Comparação',
    placeholderHash: 'Cole aqui o hash fornecido pelo autor...',
    btnCompare: 'Verificar Integridade',
    btnClear: 'Limpar Tudo',
    toastCopied: 'Hash calculado copiado!',
    statusMatch: 'Os hashes coincidem! O arquivo é autêntico.',
    statusMismatch: 'Os hashes NÃO coincidem. O arquivo pode estar corrompido ou alterado.',
    statusWaiting: 'Aguardando hash esperado para comparar...',
  },
};
