...
export const content: ToolLocaleContent<HashVerifierUI> = {
  ...
  bibliography: [
    {
      name: 'NIST : Norme des fonctions de hachage',
    ...
    {
      name: 'Wikipedia : Fonction de hachage cryptographique',
  ...
  ui: {
    labelFile: 'Sélectionnez ou faites glisser le fichier',
    labelAlgorithm: 'Sélectionnez l\'algorithme',
    labelExpectedHash: 'Hash attendu (facultatif)',
    labelStatus: 'Statut de comparaison',
    placeholderHash: 'Collez ici le hash fourni par l\'auteur...',
    btnCompare: 'Vérifier l\'intégrité',
    btnClear: 'Tout effacer',
    toastCopied: 'Hash calculé copié !',
    statusMatch: 'Les hashes correspondent ! Le fichier est authentique.',
    statusMismatch: 'Les hashes NE correspondent PAS. Le fichier pourrait être corrompu ou altéré.',
    statusWaiting: 'En attente du hash attendu pour comparaison...',
  },
};
