...
export const content: ToolLocaleContent<HashVerifierUI> = {
  ...
  bibliography: [
    {
      name: 'NIST: Standard för Hash-funktioner',
    ...
    {
      name: 'Wikipedia: Kryptografisk hashfunktion',
      url: 'https://sv.wikipedia.org/wiki/Kryptografisk_hashfunktion',
    },
  ],
  howTo: howToData,
  ...
  ui: {
    labelFile: 'Välj eller dra fil',
    labelAlgorithm: 'Välj algoritm',
    labelExpectedHash: 'Förväntat Hash-värde (valfritt)',
    labelStatus: 'Jämförelsestatus',
    placeholderHash: 'Klistra in hash-koden från författaren här...',
    btnCompare: 'Verifiera integritet',
    btnClear: 'Rensa allt',
    toastCopied: 'Beräknat hash-värde kopierat!',
    statusMatch: 'Hash-värdena matchar! Filen är autentisk.',
    statusMismatch: 'Hash-värdena matchar INTE. Filen kan vara korrupt eller ändrad.',
    statusWaiting: 'Väntar på förväntat hash-värde för jämförelse...',
  },
};
