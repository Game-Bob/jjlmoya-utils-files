...
export const content: ToolLocaleContent<HashVerifierUI> = {
  ...
  ui: {
    labelFile: 'Dosyayı seçin veya sürükleyin',
    labelAlgorithm: 'Algoritma Seçin',
    labelExpectedHash: 'Beklenen Hash (isteğe bağlı)',
    labelStatus: 'Karşılaştırma Durumu',
    placeholderHash: 'Yazar tarafından sağlanan hash\'i buraya yapıştırın...',
    btnCompare: 'Bütünlüğü Doğrula',
    btnClear: 'Hepsini Temizle',
    toastCopied: 'Hesaplanan hash kopyalandı!',
    statusMatch: 'Hash değerleri eşleşiyor! Dosya orijinaldir.',
    statusMismatch: 'Hash değerleri EŞLEŞMİYOR. Dosya bozulmuş veya değiştirilmiş olabilir.',
    statusWaiting: 'Karşılaştırmak için beklenen hash değeri bekleniyor...',
  },
};
