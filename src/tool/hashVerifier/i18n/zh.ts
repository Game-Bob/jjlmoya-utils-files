...
export const content: ToolLocaleContent<HashVerifierUI> = {
  ...
  bibliography: [
    ...
    },
    {
      ...
      url: 'https://developer.mozilla.org/zh-CN/docs/Web/API/Web_Crypto_API',
    },
    {
      name: '维基百科: 密码散列函数',
      url: 'https://zh.wikipedia.org/wiki/密码散列函数',
    },
  ],
  howTo: howToData,
  ...
  ui: {
    labelFile: '选择或拖入文件',
    labelAlgorithm: '选择算法',
    labelExpectedHash: '预期的哈希值 (可选)',
    labelStatus: '对比状态',
    placeholderHash: '在此粘贴作者提供的哈希值...',
    btnCompare: '验证完整性',
    btnClear: '清空全部',
    toastCopied: '已计算哈希值并复制！',
    statusMatch: '哈希匹配！文件是原始的。',
    statusMismatch: '哈希不匹配！文件可能已损坏或被更改。',
    statusWaiting: '等待输入预期哈希以供对比...',
  },
};
