...
export const content: ToolLocaleContent<HashVerifierUI> = {
  ...
  bibliography: [
    {
      name: 'NIST: Standard delle funzioni Hash',
    ...
    {
      name: 'Wikipedia: Funzione crittografica di hash',
  ...
  ui: {
    labelFile: 'Seleziona o trascina il file',
    labelAlgorithm: 'Seleziona Algoritmo',
    labelExpectedHash: 'Hash Atteso (opzionale)',
    labelStatus: 'Stato del Confronto',
    placeholderHash: 'Incolla qui l\'hash fornito dall\'autore...',
    btnCompare: 'Verifica Integrità',
    btnClear: 'Cancella Tutto',
    toastCopied: 'Hash calcolato copiato!',
    statusMatch: 'Gli hash corrispondono! Il file è autentico.',
    statusMismatch: 'Gli hash NON corrispondono. Il file potrebbe essere corrotto o alterato.',
    statusWaiting: 'In attesa dell\'hash atteso per il confronto...',
  },
};
