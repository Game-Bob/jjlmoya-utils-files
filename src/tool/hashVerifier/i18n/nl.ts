...
export const content: ToolLocaleContent<HashVerifierUI> = {
  ...
  ui: {
    labelTitle: "Lokale Hash Verifier",
    labelSubtitle: "Sleep een bestand om direct de <strong class=\"hv-accent\">SHA-256</strong>-handtekening te genereren.",
    btnSelect: "Bestand selecteren",
    labelPrivacy: "Bestanden verlaten nooit uw apparaat.",
    labelCalculating: "Handtekening berekenen...",
    labelSuccess: "Berekening geslaagd",
    btnAnother: "Ander bestand verifiëren",
    labelHash: "SHA-256 Hash",
    btnCopyTitle: "Hash kopiëren",
    labelCompare: "Vergelijk met origineel",
    placeholderCompare: "Plak hier de verwachte hash...",
    labelCompareNote: "* Vergelijking negeert hoofd-/kleine letters en witruimte.",
    statusVerified: "GEVERIFIEERD",
    statusCorrupt: "BESCHADIGD / FOUT"
  }
};
