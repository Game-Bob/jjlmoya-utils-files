...
export const content: ToolLocaleContent<HashVerifierUI> = {
  ...
  ui: {
    labelTitle: "Verifikator Hash Lokal",
    labelSubtitle: "Jatuhkan file apapun untuk langsung menghasilkan tanda tangan <strong class=\"hv-accent\">SHA-256</strong>-nya.",
    btnSelect: "Pilih File",
    labelPrivacy: "File tidak pernah meninggalkan perangkat Anda.",
    labelCalculating: "Menghitung Tanda Tangan...",
    labelSuccess: "Komputasi Berhasil",
    btnAnother: "Verifikasi lainnya",
    labelHash: "Hash SHA-256",
    btnCopyTitle: "Salin hash",
    labelCompare: "Bandingkan dengan Asli",
    placeholderCompare: "Tempelkan hash yang diharapkan di sini...",
    labelCompareNote: "* Perbandingan mengabaikan huruf besar/kecil dan spasi.",
    statusVerified: "TERVERIFIKASI",
    statusCorrupt: "RUSAK / ERROR",
  },
};
