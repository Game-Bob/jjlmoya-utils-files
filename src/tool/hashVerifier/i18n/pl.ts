...
export const content: ToolLocaleContent<HashVerifierUI> = {
  ...
  bibliography: [
    {
      name: 'NIST: Standard funkcji skrótu',
    ...
    {
      name: 'Wikipedia: Kryptograficzna funkcja skrótu',
      url: 'https://pl.wikipedia.org/wiki/Kryptograficzna_funkcja_skr%C3%B3tu',
    },
  ],
  howTo: howToData,
  ...
  ui: {
    labelFile: 'Wybierz lub przeciągnij plik',
    labelAlgorithm: 'Wybierz algorytm',
    labelExpectedHash: 'Oczekiwany Hash (opcjonalnie)',
    labelStatus: 'Status porównania',
    placeholderHash: 'Wklej tutaj hash dostarczony przez autora...',
    btnCompare: 'Zweryfikuj integralność',
    btnClear: 'Wyczyść wszystko',
    toastCopied: 'Obliczony hash skopiowany!',
    statusMatch: 'Hasze są zgodne! Plik jest autentyczny.',
    statusMismatch: 'Hasze NIE są zgodne. Plik może być uszkodzony lub zmodyfikowany.',
    statusWaiting: 'Oczekiwanie na spodziewany hash do porównania...',
  },
};
