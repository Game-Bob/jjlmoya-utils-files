...
export const content: ToolLocaleContent<HashVerifierUI> = {
  ...
  ui: {
    labelTitle: "Lokaler Hash-Prüfer",
    labelSubtitle: "Legen Sie eine Datei ab, um sofort ihre <strong class=\"hv-accent\">SHA-256</strong>-Signatur zu erzeugen.",
    btnSelect: "Datei auswählen",
    labelPrivacy: "Dateien verlassen niemals Ihr Gerät.",
    labelCalculating: "Signatur wird berechnet...",
    labelSuccess: "Berechnung erfolgreich",
    btnAnother: "Weitere prüfen",
    labelHash: "SHA-256 Hash",
    btnCopyTitle: "Hash kopieren",
    labelCompare: "Mit Original vergleichen",
    placeholderCompare: "Erwarteten Hash hier einfügen...",
    labelCompareNote: "* Vergleich ignoriert Groß-/Kleinschreibung und Leerzeichen.",
    statusVerified: "VERIFIZIERT",
    statusCorrupt: "BESCHÄDIGT / FEHLER"
  }
};
