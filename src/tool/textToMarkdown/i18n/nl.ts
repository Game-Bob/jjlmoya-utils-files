...
export const content: ToolLocaleContent<TextToMarkdownUI> = {
  ...
  bibliography: [
    { name: 'CommonMark: Standaard Markdown Specificatie', url: 'https://commonmark.org/' },
    { name: 'Daring Fireball: Het originele Markdown project', url: 'https://daringfireball.net/projects/markdown/' },
