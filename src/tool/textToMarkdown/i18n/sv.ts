...
export const content: ToolLocaleContent<TextToMarkdownUI> = {
  ...
  bibliography: [
    { name: 'CommonMark: Standardspecifikation för Markdown', url: 'https://commonmark.org/' },
    { name: 'Daring Fireball: Det ursprungliga Markdown-projektet', url: 'https://daringfireball.net/projects/markdown/' },
