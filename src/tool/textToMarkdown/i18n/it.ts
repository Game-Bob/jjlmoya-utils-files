...
export const content: ToolLocaleContent<TextToMarkdownUI> = {
  ...
  bibliography: [
    { name: 'CommonMark: Specifica standard del Markdown', url: 'https://commonmark.org/' },
    { name: 'Daring Fireball: Il progetto Markdown originale', url: 'https://daringfireball.net/projects/markdown/' },
