...
export const content: ToolLocaleContent<TextToMarkdownUI> = {
  ...
  bibliography: [
    { name: 'CommonMark: Standard-Markdown-Spezifikation', url: 'https://commonmark.org/' },
    { name: 'Daring Fireball: Das ursprüngliche Markdown-Projekt', url: 'https://daringfireball.net/projects/markdown/' },
