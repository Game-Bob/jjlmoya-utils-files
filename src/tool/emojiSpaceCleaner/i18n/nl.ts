...
export const content: ToolLocaleContent<EmojiSpaceCleanerUI> = {
  ...
  bibliography: [
    {
      name: 'Unicode Standaard: Emoji\'s en Pictogrammen',
      url: 'https://unicode.org/emoji/charts/full-emoji-list.html',
    },
    {
      name: 'MDN: Reguliere Expressies in JavaScript (RegExp)',
      url: 'https://developer.mozilla.org/nl/docs/Web/JavaScript/Guide/Regular_expressions',
    },
    {
      name: 'W3C: Omgaan met witruimte op het web',
