...
export const content: ToolLocaleContent<EmojiSpaceCleanerUI> = {
  ...
  bibliography: [
    {
      name: 'Standard Unicode: Emoji e Simboli Pittografici',
      url: 'https://unicode.org/emoji/charts/full-emoji-list.html',
    },
    {
      name: 'MDN: Espressioni Regolari in JavaScript (RegExp)',
      url: 'https://developer.mozilla.org/it/docs/Web/JavaScript/Guide/Regular_expressions',
    },
    {
      name: 'W3C: Gestione degli spazi bianchi sul web',
