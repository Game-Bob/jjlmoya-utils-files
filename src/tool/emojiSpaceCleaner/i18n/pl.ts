...
export const content: ToolLocaleContent<EmojiSpaceCleanerUI> = {
  ...
  bibliography: [
    {
      name: 'Standard Unicode: Emoji i symbole piktograficzne',
      url: 'https://unicode.org/emoji/charts/full-emoji-list.html',
    },
    {
      name: 'MDN: Wyrażenia regularne w JavaScript (RegExp)',
      url: 'https://developer.mozilla.org/pl/docs/Web/JavaScript/Guide/Regular_expressions',
    },
    {
      name: 'W3C: Obsługa białych znaków w sieci',
