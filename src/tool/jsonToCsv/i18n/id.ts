...
export const content: ToolLocaleContent<JsonToCsvUI> = {
  ...
  ui: {
    statusWaiting: 'Menunggu JSON Valid',
    statusValid: 'JSON Valid',
    statusInvalid: 'JSON Tidak Valid',
    labelFlatten: 'Ratakan Objek',
    zoneLabel: 'Tempel JSON di sini atau seret file',
    placeholderJson: '[{"id": 1, "name": "John", "details": {"age": 30}}]',
    btnCopyCsv: 'Salin CSV',
    btnDownloadCsv: 'Unduh Excel (CSV)',
