...
export const content: ToolLocaleContent<JsonToCsvUI> = {
  ...
  bibliography: [
    { name: 'RFC 4180 : Spécification du format CSV', url: 'https://tools.ietf.org/html/rfc4180' },
    { name: 'ECMA-404 : La norme d\'échange de données JSON', url: 'https://www.json.org/json-en.html' },
    { name: 'Microsoft : Importer du CSV dans Excel', url: 'https://support.microsoft.com/fr-fr/office/importer-ou-exporter-des-fichiers-texte-txt-ou-csv-5250ac4c-663c-47ce-937b-339e391393ba' },
  ],
  howTo: howToData,
  ...
  ui: {
    labelInput: 'JSON Source',
    labelOutput: 'CSV Résultant',
    placeholderInput: 'Collez ici votre tableau JSON (ex: [{"id": 1, "name": "Jean"}])',
    placeholderOutput: 'Le CSV généré apparaîtra ici...',
    btnConvert: 'Convertir maintenant',
    btnDownload: 'Télécharger le CSV',
    btnCopy: 'Copier le résultat',
    btnClear: 'Tout effacer',
    toastCopied: 'CSV copié dans le presse-papiers !',
    toastDownloaded: 'Téléchargement du fichier CSV...',
    errorInvalidJson: 'Format JSON invalide. Veuillez vérifier vos données.',
  },
};
