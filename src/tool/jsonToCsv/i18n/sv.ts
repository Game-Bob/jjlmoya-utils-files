...
export const content: ToolLocaleContent<JsonToCsvUI> = {
  ...
  ui: {
    statusWaiting: 'Väntar på giltig JSON',
    statusValid: 'Giltig JSON',
    statusInvalid: 'Ogiltig JSON',
    labelFlatten: 'Platta ut objekt',
    zoneLabel: 'Klistra in din JSON här eller dra en fil',
    placeholderJson: '[{"id": 1, "name": "John", "details": {"age": 30}}]',
    btnCopyCsv: 'Kopiera CSV',
    btnDownloadCsv: 'Ladda ner Excel (CSV)',
