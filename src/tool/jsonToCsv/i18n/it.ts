...
export const content: ToolLocaleContent<JsonToCsvUI> = {
  ...
  bibliography: [
    { name: 'RFC 4180: Specifica del formato CSV', url: 'https://tools.ietf.org/html/rfc4180' },
    { name: 'ECMA-404: Lo standard di scambio dati JSON', url: 'https://www.json.org/json-en.html' },
    { name: 'Microsoft: Importare CSV in Excel', url: 'https://support.microsoft.com/it-it/office/importare-o-esportare-file-di-testo-txt-o-csv-5250ac4c-663c-47ce-937b-339e391393ba' },
  ],
  howTo: howToData,
  ...
  ui: {
    labelInput: 'JSON Sorgente',
    labelOutput: 'CSV Risultante',
    placeholderInput: 'Incolla qui il tuo array JSON (es: [{"id": 1, "name": "Mario"}])',
    placeholderOutput: 'Il CSV generato apparirà qui...',
    btnConvert: 'Converti Ora',
    btnDownload: 'Scarica CSV',
    btnCopy: 'Copia risultato',
    btnClear: 'Cancella Tutto',
    toastCopied: 'CSV copiato negli appunti!',
    toastDownloaded: 'Download del file CSV in corso...',
    errorInvalidJson: 'Formato JSON non valido. Controlla i tuoi dati.',
  },
};
