...
export const content: ToolLocaleContent<JsonToCsvUI> = {
  ...
  bibliography: [
    { name: 'RFC 4180: Спецификация формата CSV', url: 'https://tools.ietf.org/html/rfc4180' },
    { name: 'ECMA-404: Стандарт обмена данными JSON', url: 'https://www.json.org/json-en.html' },
    { name: 'Microsoft: Импорт CSV в Excel', url: 'https://support.microsoft.com/ru-ru/office/импорт-или-экспорт-текстовых-файлов-txt-или-csv-5250ac4c-663c-47ce-937b-339e391393ba' },
  ],
  howTo: howToData,
  ...
  ui: {
    labelInput: 'Исходный JSON',
    labelOutput: 'Итоговый CSV',
    placeholderInput: 'Вставьте сюда ваш JSON-массив (напр., [{"id": 1, "name": "Иван"}])',
    placeholderOutput: 'Сгенерированный CSV появится здесь...',
    btnConvert: 'Конвертировать сейчас',
    btnDownload: 'Скачать CSV',
    btnCopy: 'Копировать результат',
    btnClear: 'Очистить всё',
    toastCopied: 'CSV скопирован в буфер обмена!',
    toastDownloaded: 'Скачивание CSV файла...',
    errorInvalidJson: 'Неверный формат JSON. Пожалуйста, проверьте ваши данные.',
  },
};
