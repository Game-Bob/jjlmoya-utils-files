...
export const content: ToolLocaleContent<JsonToCsvUI> = {
  ...
  bibliography: [
    { name: 'RFC 4180: Especificação do formato CSV', url: 'https://tools.ietf.org/html/rfc4180' },
    { name: 'ECMA-404: O padrão de intercâmbio de dados JSON', url: 'https://www.json.org/json-en.html' },
    { name: 'Microsoft: Importar CSV para o Excel', url: 'https://support.microsoft.com/pt-pt/office/importar-ou-exportar-ficheiros-de-texto-txt-ou-csv-5250ac4c-663c-47ce-937b-339e391393ba' },
  ],
  howTo: howToData,
  ...
  ui: {
    labelInput: 'JSON de Origem',
    labelOutput: 'CSV Resultante',
    placeholderInput: 'Cole aqui o seu array JSON (ex: [{"id": 1, "name": "Joao"}])',
    placeholderOutput: 'O CSV gerado aparecerá aqui...',
    btnConvert: 'Converter Agora',
    btnDownload: 'Descarregar CSV',
    btnCopy: 'Copiar resultado',
    btnClear: 'Limpar Tudo',
    toastCopied: 'CSV copiado para a área de transferência!',
    toastDownloaded: 'A descarregar ficheiro CSV...',
    errorInvalidJson: 'Formato JSON inválido. Por favor, verifique os seus dados.',
  },
};
