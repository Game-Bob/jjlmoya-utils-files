...
export const content: ToolLocaleContent<JsonToCsvUI> = {
  ...
  bibliography: [
    { name: 'RFC 4180: CSV-formaat specificatie', url: 'https://tools.ietf.org/html/rfc4180' },
    { name: 'ECMA-404: De JSON-gegevensuitwisselingsnorm', url: 'https://www.json.org/json-en.html' },
    { name: 'Microsoft: CSV importeren in Excel', url: 'https://support.microsoft.com/nl-nl/office/tekstbestanden-txt-of-csv-importeren-of-exporteren-5250ac4c-663c-47ce-937b-339e391393ba' },
  ],
  howTo: howToData,
  ...
  ui: {
    labelInput: 'Bron JSON',
    labelOutput: 'Resulterende CSV',
    placeholderInput: 'Plak hier uw JSON-array (bijv. [{"id": 1, "name": "Jan"}])',
    placeholderOutput: 'De gegenereerde CSV verschijnt hier...',
    btnConvert: 'Nu converteren',
    btnDownload: 'CSV downloaden',
    btnCopy: 'Resultaat kopiëren',
    btnClear: 'Alles wissen',
    toastCopied: 'CSV gekopieerd naar klembord!',
    toastDownloaded: 'CSV-bestand wordt gedownload...',
    errorInvalidJson: 'Ongeldig JSON-formaat. Controleer uw gegevens.',
  },
};
