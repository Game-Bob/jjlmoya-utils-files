...
export const content: ToolLocaleContent<JsonToCsvUI> = {
  ...
  bibliography: [
    { name: 'RFC 4180: CSV 格式规范', url: 'https://tools.ietf.org/html/rfc4180' },
    { name: 'ECMA-404: JSON 数据交换标准', url: 'https://www.json.org/json-en.html' },
    { name: 'Microsoft: 将 CSV 导入 Excel', url: 'https://support.microsoft.com/zh-cn/office/%E5%AF%BC%E5%85%A5%E6%88%96%E5%AF%BC%E5%87%BA%E6%96%87%E6%9C%AC-txt-%E6%88%96-csv-%E6%96%87%E4%BB%B6-5250ac4c-663c-47ce-937b-339e391393ba' },
  ],
  howTo: howToData,
  ...
  ui: {
    labelInput: '源 JSON',
    labelOutput: '转换后的 CSV',
    placeholderInput: '在此粘贴您的 JSON 数组（例如：[{"id": 1, "name": "张三"}]）',
    placeholderOutput: '生成的 CSV 将显示在这里...',
    btnConvert: '立即转换',
    btnDownload: '下载 CSV',
    btnCopy: '复制结果',
    btnClear: '全部清空',
    toastCopied: 'CSV 已复制到剪贴板！',
    toastDownloaded: '正在下载 CSV 文件...',
    errorInvalidJson: 'JSON 格式无效。请检查您的数据。',
  },
};
