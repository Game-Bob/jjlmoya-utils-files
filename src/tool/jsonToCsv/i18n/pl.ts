...
export const content: ToolLocaleContent<JsonToCsvUI> = {
  ...
  bibliography: [
    { name: 'RFC 4180: Specyfikacja formatu CSV', url: 'https://tools.ietf.org/html/rfc4180' },
    { name: 'ECMA-404: Standard wymiany danych JSON', url: 'https://www.json.org/json-en.html' },
    { name: 'Microsoft: Importowanie plików CSV do Excela', url: 'https://support.microsoft.com/pl-pl/office/importowanie-lub-eksportowanie-plik%C3%B3w-tekstowych-txt-lub-csv-5250ac4c-663c-47ce-937b-339e391393ba' },
  ],
  howTo: howToData,
  ...
  ui: {
    labelInput: 'Źródłowy JSON',
    labelOutput: 'Wynikowy CSV',
    placeholderInput: 'Wklej tutaj swoją tablicę JSON (np. [{"id": 1, "name": "Jan"}])',
    placeholderOutput: 'Wygenerowany CSV pojawi się tutaj...',
    btnConvert: 'Konwertuj teraz',
    btnDownload: 'Pobierz CSV',
    btnCopy: 'Kopiuj wynik',
    btnClear: 'Wyczyść wszystko',
    toastCopied: 'CSV skopiowany do schowka!',
    toastDownloaded: 'Pobieranie pliku CSV...',
    errorInvalidJson: 'Nieprawidłowy format JSON. Proszę sprawdź swoje dane.',
  },
};
