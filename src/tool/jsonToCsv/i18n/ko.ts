...
export const content: ToolLocaleContent<JsonToCsvUI> = {
  ...
  bibliography: [
    { name: 'RFC 4180: CSV 형식 사양', url: 'https://tools.ietf.org/html/rfc4180' },
    { name: 'ECMA-404: JSON 데이터 교환 표준', url: 'https://www.json.org/json-en.html' },
    { name: 'Microsoft: Excel로 CSV 가져오기', url: 'https://support.microsoft.com/ko-kr/office/%ED%85%8D%EC%8A%A4%ED%8A%B8-txt-%EB%98%90%EB%8A%94-csv-%ED%8C%8C%EC%9D%BC-%EA%B0%80%EC%A0%B8%EC%98%A4%EA%B8%B0-%EB%98%90%EB%8A%94-%EB%82%B4%EB%B3%B4%EB%82%B4%EA%B8%B0-5250ac4c-663c-47ce-937b-339e391393ba' },
  ],
  howTo: howToData,
  ...
  ui: {
    labelInput: '원본 JSON',
    labelOutput: '결과 CSV',
    placeholderInput: '여기에 JSON 배열을 붙여넣으세요 (예: [{"id": 1, "name": "철수"}])',
    placeholderOutput: '생성된 CSV가 여기에 나타납니다...',
    btnConvert: '지금 변환',
    btnDownload: 'CSV 다운로드',
    btnCopy: '결과 복사',
    btnClear: '모두 지우기',
    toastCopied: 'CSV가 클립보드로 복사되었습니다!',
    toastDownloaded: 'CSV 파일을 다운로드 중...',
    errorInvalidJson: '유효하지 않은 JSON 형식입니다. 데이터를 확인해 주세요.',
  },
};
